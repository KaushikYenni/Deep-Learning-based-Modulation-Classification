...
for row = 1:NTrain
    ...
    for col = 1:L
        ...
        signal_data(row, col) = sqrt(P)*h*exp(j*phase_jitter)*s + sqrt(1/2)*(randn+j*randn);
    end
end
for row = 1:NTrain
...
save('train_data_rayleigh_100k.mat', 'train_data', '-mat');
save('train_label_rayleigh_100k.mat', 'train_label', '-mat');
